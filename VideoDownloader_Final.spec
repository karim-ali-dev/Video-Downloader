...
a = Analysis(
    ...
    datas=[('tools', 'tools'), ('C:/Users/karim/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/Lib/tkinter', 'tkinter'), ('_internal/_tcl_data', '_tcl_data'), ('_internal/_tk_data', '_tk_data')],
